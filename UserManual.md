...
- 「文章インポート」直後のモーダルでは、関連WordPackカードで「生成」ボタンとプレビュー（語彙名クリック）を利用できます。
...
2. テキストエリアに文章（日本語/英語）を貼り付け、「インポート」をクリックします。
3. 右下に進捗通知が表示され、完了後にモーダルで詳細が開きます。
...
4. 「インポート済み文章」一覧から、保存済みの文章を再表示できます。不要になった記事は削除してください。
